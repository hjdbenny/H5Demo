...
$.fn.xb_scroll = function(options)
{
	...
	var jqScrollBox = $("<div style='position:absolute;width:"+opts.boxWidth+"px;top:"+opts.barOffTop+"px;right:"+opts.barOffRight+"px;bottom:"+opts.barOffBottom+"px;background:#ffffff;'></div>");
	jqScrollBox.addClass(opts.boxClass);
	var jqScrollBar= $("<div style='position:absolute;width:"+opts.barWidth+"px;top:"+opts.barOffTop+"px;right:"+opts.barOffRight+"px;;background: #5393f1;'></div>");
	...
	jqScrollBar.on("mousedown",function(ev){
		...
		jqScrollBar.css({"background":"#5393f1"});
